...
{
    public class RecolorModel : PageModel
    {
        ...
        public RecolorModel(ILogger<PageModel> logger, IHostEnvironment environment, EmojisService recolorService, IArtPieceRepository artPieceRepository)
        {
            _logger = logger;
